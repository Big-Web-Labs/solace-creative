...
const Navbar = () => {
    ...
    return (
        <div className="relative">
            {location.pathname == "/" &&
                <motion.ul className="absolute hidden md:flex md:flex-row items-center md:items-start justify-center gap-y-5 md:justify-between h-screen w-full text-[#F3F3F3] text-[1.5rem] md:text-[1rem] lg:text-[1.25rem] xl:text-[2rem]">
                    <motion.li initial={animateFrom} animate={animateTo} transition={{ delay: 0.10 }}>
                        ...
                        {hover == 1 && <motion.p animate={{ opacity: [0, 1] }} className="text-[1rem] w-[135px] xl:w-[275px] text-[#F3F3F3]/80">Every project that we take on becomes woven into our DNA. Here's a selection of our works:</motion.p>}
                    </motion.li>
                    ...
                    <motion.li initial={animateFrom} animate={animateTo} transition={{ delay: 0.40 }}>
                        ...
                        {hover == 4 && <motion.p animate={{ opacity: [0, 1] }} className="text-[1rem] w-[70px] xl:w-[135px] text-[#F3F3F3]/80">Few things get us as excited as a new project and a new partnership. Hit us up:</motion.p>}
                    </motion.li>
                </motion.ul>
            }
